...
class BufferManager{
    ...
    Page getTempPage(string pageName, int columnCount, int rowCount);
    ...
    void writeTempPage(string pageName, vector<vector<int>> rows, int rowCount);

    Page getPageByFileName(const string &pageName);
    void writePageByFileName(const string &pageName, vector<vector<int>> rows, int rowCount);
    void deleteFileByFileName(const string &fileName);
    void trimPool();
    void clearPool();
